            ...
            HStack {
                ...
                Button(isEditing ? "Update" : "Create") {
                    if isEditing {
                        ...
                        selectedQuote?.pageNumber = page.isEmpty ? nil : page
                        page = ""
                        text = ""
                        selectedQuote = nil
                    } else {
                        let quote = page.isEmpty ? Quote(text: text) : Quote(text: text, pageNumber: page)
        ...
        List {
            ...
            ForEach(sortedQuotes) { quote in
                VStack(alignment: .leading) {
                    ...
                    HStack {
                        Spacer()
                        if let page = quote.pageNumber, !page.isEmpty {
                            Text("Page: \(page)")
                        }
                    }
                }
